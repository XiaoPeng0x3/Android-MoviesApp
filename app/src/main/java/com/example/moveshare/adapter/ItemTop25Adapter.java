package com.example.moveshare.adapter;
...
import com.example.moveshare.utils.CelebrityUtil;
import com.example.moveshare.utils.StringUtil;
import com.nostra13.universalimageloader.core.ImageLoader;

import java.util.List;

public class ItemTop25Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ItemTop25Adapter(List<SimpleSubjectBean> movieList, Context context) {
...
//        this.ss.addAll(ss);//加入新数据
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if(viewType==0) {
            View v = layoutInflater.inflate(R.layout.item_top25_layout, parent, false);
